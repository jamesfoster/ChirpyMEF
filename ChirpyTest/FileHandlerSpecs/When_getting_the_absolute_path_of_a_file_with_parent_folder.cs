namespace ChirpyTest.FileHandlerSpecs
{
	...
	public class When_getting_the_absolute_path_of_a_file_with_parent_folder
	{
		...
		It should_be_correct_path = () => result.ShouldBeEqualIgnoringCase(@"c:\path\folder\file.txt");
	}
}